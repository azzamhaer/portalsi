    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#121218] border border-white/10 w-full max-w-sm rounded-3xl shadow-2xl overflow-hidden animate-scale-in">
        <div className="p-6">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">{t('timer.title')}</h2>
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex gap-4 mb-6">
              <div className="flex-1">
                <label className="block text-xs font-semibold text-white/50 uppercase tracking-wider mb-2">{t('timer.minutes')}</label>
                <input
                  type="number"
                  min="0"
                  max="120"
              ...
              <div className="flex-1">
                <label className="block text-xs font-semibold text-white/50 uppercase tracking-wider mb-2">{t('timer.seconds')}</label>
                <input
                  type="number"
                  min="0"
                  max="59"
