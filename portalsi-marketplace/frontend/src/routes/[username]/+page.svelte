...
<div class="container-x py-6">
  ...
  <div class="card flex items-center gap-6 flex-wrap mb-10">
    ...
    <div class="flex items-center gap-6 text-sm">
      ...
      <div><div class="font-display text-xl font-bold tracking-tightest">{(v.total_sold ?? 0).toLocaleString('id-ID')}</div><div class="text-xs text-ink-500">{$t('store.sales')}</div></div>
