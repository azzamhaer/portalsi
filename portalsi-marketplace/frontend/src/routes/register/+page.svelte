...
<div class="container-x py-16 grid place-items-center min-h-[60vh]">
  <div class="w-full max-w-md card">
    ...
    <p class="text-center text-sm text-ink-500 mb-8">Buat akun Portal SI untuk marketplace dan layanan Portal SI lainnya.</p>
    <form on:submit={submit} class="space-y-4">
      <div><label class="label">Username Portal SI</label><input required bind:value={username} class="input" placeholder="contoh: azzam.hudiya" pattern="[A-Za-z0-9._]+" /></div>
