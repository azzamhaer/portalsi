...
class RajaOngkirService
{
    ...
    public function enabled(): bool
    {
        ...
        $raw = Setting::get('rajaongkir_enabled', config('services.marketplace.rajaongkir.enabled', false));
    ...
    {
        return Setting::get('rajaongkir_mode', config('services.marketplace.rajaongkir.mode', 'sandbox')) ?: 'sandbox';
    }

    public function apiKey(): ?string
    {
        return Setting::get('rajaongkir_api_key', config('services.marketplace.rajaongkir.api_key'));
    }
    ...
    public function tariffBaseUrl(): string
    {
        return rtrim((string) Setting::get(
            ...
            config('services.marketplace.rajaongkir.tariff_base_url', $this->mode() === 'production'
    ...
    public function orderBaseUrl(): string
    {
        return rtrim((string) Setting::get(
            ...
            config('services.marketplace.rajaongkir.order_base_url', $this->mode() === 'production'
