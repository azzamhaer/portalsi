...
class BrevoService
{
    ...
    {
        $this->apiKey      = Setting::get('brevo_api_key', config('services.marketplace.brevo.api_key', ''));
        $this->senderEmail = Setting::get('brevo_sender_email', config('services.marketplace.brevo.sender_email', 'noreply@mpsi.id'));
        $this->senderName  = Setting::get('brevo_sender_name', config('services.marketplace.brevo.sender_name', Setting::get('app_name', 'MPSI')));
    }
