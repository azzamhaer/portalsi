...
use App\Marketplace\Exceptions\PortalSiIdentityException;
use App\Marketplace\Models\Category;
use App\Marketplace\Models\Order;
use App\Marketplace\Models\OrderReturn;
use App\Marketplace\Models\ShippingOption;
use App\Marketplace\Models\Tag;
use App\Marketplace\Models\User;
use App\Marketplace\Models\Vendor;
use App\Marketplace\Services\PortalSiIdentityService;
...
class AdminController extends Controller
{
    ...
    public function freshStartSummary()
    {
        return response()->json([
            ...
            'vendors' => Vendor::count(),
            'products' => \App\Marketplace\Models\Product::count(),
            'orders' => Order::count(),
            'order_items' => \App\Marketplace\Models\OrderItem::count(),
            'payments' => \App\Marketplace\Models\Payment::count(),
            'returns' => OrderReturn::count(),
            'chats' => \App\Marketplace\Models\ChatThread::count(),
            'chat_messages' => \App\Marketplace\Models\ChatMessage::count(),
            'reports' => \App\Marketplace\Models\Report::count(),
            'notifications' => \App\Marketplace\Models\UserNotification::count(),
            'wishlists' => \App\Marketplace\Models\Wishlist::count(),
            'reviews' => \App\Marketplace\Models\Review::count(),
            'withdrawals' => \App\Marketplace\Models\Withdrawal::count(),
            'user_withdrawals' => \App\Marketplace\Models\UserWithdrawal::count(),
            'user_wallet_transactions' => \App\Marketplace\Models\UserWalletTransaction::count(),
            'vouchers' => \App\Marketplace\Models\SellerVoucher::count(),
            'kept' => [
                'settings',
                'shipping_options',
                'payment_methods',
    ...
    public function userDetail($id)
    {
        ...
        $orders = \App\Marketplace\Models\Order::where('user_id', $user->id)
        ...
        if ($user->vendor) {
            $vendorProducts = \App\Marketplace\Models\Product::where('vendor_id', $user->vendor->id)
                ->with('tagModels:id,slug')->withCount('reviews')->orderByDesc('id')->take(50)->get();
            $vendorOrders = \App\Marketplace\Models\OrderItem::where('vendor_id', $user->vendor->id)
    ...
    public function approveReturn(Request $request, $id)
    {
        ...
        DB::transaction(function () use ($r, $data) {
            ...
            \App\Marketplace\Models\UserWalletTransaction::firstOrCreate(
