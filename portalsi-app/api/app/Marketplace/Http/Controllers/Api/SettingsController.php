...
class SettingsController extends Controller
{
    ...
    public function adminSettings()
    {
        return response()->json([
            ...
            'tagline'       => Setting::get('tagline', 'Marketplace untuk semua'),
            'tripay_mode'   => Setting::get('tripay_mode', config('services.marketplace.tripay.mode')),
            ...
            'rajaongkir_mode' => Setting::get('rajaongkir_mode', config('services.marketplace.rajaongkir.mode', 'sandbox')),
