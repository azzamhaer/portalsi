<script lang="ts">
	import { LogOut, LayoutGrid, HelpCircle, ShieldCheck } from '@lucide/svelte';
...
<div class="wrap">
	{#if !isAuth}
		<header class="top">
			<a class="brand" href="/" aria-label="KBIHU Ar-Rahman Mail">
				<img src="/logo.png" alt="KBIHU Ar-Rahman" />
			</a>
			{#if data.user}
				<div class="appswitch">
					...
					{#if menuOpen}
						...
						<div class="menu">
							{#if data.user.is_admin}
								<a href="/admin" class="menu-row" onclick={() => (menuOpen = false)}><ShieldCheck size={16} /> Panel Admin</a>
								<div class="menu-sep"></div>
							{/if}
							<a href="https://wa.me/6281350880733?text=Assalamu%27alaikum%20wr.%20wb.%20%F0%9F%99%8F%0A%0ASaya%20ingin%20bertanya%20seputar%20layanan%20email%20KBIHU%20Ar-Rahman.%20Boleh%20dibantu%3F" target="_blank" rel="noopener" class="menu-row"><HelpCircle size={16} /> {$t('menu.help')}</a>
